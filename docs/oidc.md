...
* **OpenID プロバイダー (OP: OpenID Provider)**
...
* **個人特定可能情報 (PII: Personally Identifiable Information)**
...
* **自己発行型 OpenID プロバイダー (SIOP: Self-Issued OpenID Provider)**
